...
window.onscroll = function() {
    ...
    var four = document.getElementsByClassName('hub-slide-four')[0];
    var five = document.getElementsByClassName('hub-slide-five')[0];
    ...
    if (off.y >= '1495') {
        ...
        h3.textContent = "It's a piece of cake to find the best college, get scholarships, and access on-demand online tutoring";
        h3.style.opacity = "1";
    }
    ...
    if (off.y >= '2095') {
        ...
        h2.textContent = "We help students work hard AND play hard";
        h3.textContent = "Chegg collaborates with artists like Ed Sheeran and Macklemore & Ryan Lewis to give Music 101 lessons on college campuses";
    }
    ...
    if (off.y >= '2295') {
        ...
        h2.textContent = "And we're there for their next big adventure";
        h3.textContent = "Students use Chegg to discover internships and find their first dream job";
    }


    if ((off.y > '2495') || (off.y < '1495')) {
